...
- 2026-08-01: в списке мероприятий добавлена кнопка «Напомнить». Она
  активируется через 48 часов после создания только для опубликованного
  предстоящего мероприятия и отправляет повторный push всем устройствам.
